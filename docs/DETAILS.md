...
Everything the [README](../README.md) leaves out: how to run it, what the
simulated HR system contains, all 21 eval cases, the agent's reasoning traces,
and what SIA reported.
...
![SIA Foundry overview](sia-overview.png)
